...
import de.tu_darmstadt.seemoo.HardWhere.Utils.Companion.PREFS_APP
import de.tu_darmstadt.seemoo.HardWhere.Utils.Companion.PREFS_KEY_BACKEND
import de.tu_darmstadt.seemoo.HardWhere.Utils.Companion.PREFS_KEY_FIRST_RUN
import de.tu_darmstadt.seemoo.HardWhere.Utils.Companion.PREFS_KEY_TOKEN
import de.tu_darmstadt.seemoo.HardWhere.Utils.Companion.PREFS_KEY_UID
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_own, R.id.nav_checkin, R.id.nav_scan,R.id.nav_about,R.id.nav_logout, R.id.nav_dev
            ), drawerLayout
        )
